  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      darkTheme: ThemeData(
        ...
        fontFamily: UITextStyles.fontOnest,
        scaffoldBackgroundColor: UIColors.dark.pageBackground,
        colorScheme: ColorScheme.dark(
          primary: UIColors.dark.primary,
          onPrimary: UIColors.dark.highlightArea,
          secondary: UIColors.dark.secondary1,
          onSecondary: UIColors.dark.text,
          surface: UIColors.dark.cardBackground,
          onSurface: UIColors.dark.text,
          outline: UIColors.dark.borders,
          error: UIColors.dark.secondary2,
          onError: UIColors.dark.highlightArea,
        ),
      ),
